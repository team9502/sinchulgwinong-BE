...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 1342025275L;
    ...
    public final team9502.sinchulgwinong.domain.companyUser.entity.QCompanyUser cpUser;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cpUser = inits.isInitialized("cpUser") ? new team9502.sinchulgwinong.domain.companyUser.entity.QCompanyUser(forProperty("cpUser"), inits.get("cpUser")) : null;
